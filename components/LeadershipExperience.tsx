  ...
  return (
    <section className="py-16 bg-gray-900 text-white">
      <div className="max-w-6xl mx-auto px-6">
        {/* Section Title */}
        <h2 className="text-4xl font-bold text-center mb-12">Leadership <span className="text-amber-300">Experience</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {leadershipRoles.map((role) => (
            <div
              key={role.id}
              className="bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-transform transform hover:scale-105"
            >
